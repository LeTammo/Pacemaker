...
def transform_activity(raw: dict) -> dict:
    ...
    return {
        ...
        "total_reps": _safe_int(raw.get("totalReps")),
        "total_sets": _safe_int(raw.get("totalSets") or raw.get("activeSets")),
        "active_sets": _safe_int(raw.get("activeSets")),
        "max_weight": (_safe_float(raw.get("maxWeight")) / 1000.0) if _safe_float(raw.get("maxWeight")) and _safe_float(raw.get("maxWeight")) > 500 else _safe_float(raw.get("maxWeight")),
        "summarized_exercise_sets": raw.get("summarizedExerciseSets"),
